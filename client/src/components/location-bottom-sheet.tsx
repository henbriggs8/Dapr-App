        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 px-1">
            {applePayAvailable && !googlePayAvailable && (
              <svg viewBox="0 0 50 20" width="38" height="15" aria-hidden="true" fill="currentColor" className="text-gray-500 shrink-0">
            ...
            {googlePayAvailable && !applePayAvailable && (
              <svg viewBox="0 0 60 24" width="42" height="17" aria-hidden="true" fill="none">
