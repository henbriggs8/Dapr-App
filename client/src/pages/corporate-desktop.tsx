        ...
        <div className="max-w-[1280px] mx-auto px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <Benefit
              icon={Clock}
              title="Zero downtime"
              body="We work around your hours — early mornings, overnights, or while drivers are off-site."
            />
            <Benefit
              icon={ShieldCheck}
              title="Insured & vetted teams"
              body="Background-checked detailers, full liability coverage, and a zero-scratch wash methodology."
            />
            <Benefit
              icon={ReceiptText}
              title="One contract, one invoice"
              body="Single point of contact across every site, with a monthly invoice and locked pricing."
            />
            <Benefit
              icon={Truck}
              title="Fully self-sufficient"
              body="We bring our own water, power, and disposal — no impact on your facility or utilities."
            />
            <Benefit
              icon={MapPin}
              title="Multi-site coverage"
              body="Roll out the same program across regions with consistent quality and reporting."
            />
            <Benefit
              icon={Briefcase}
              title="Tailored programs"
              body="Frequency, scope, and SLAs designed around your fleet — not a one-size-fits-all package."
            />
          </div>
        </div>
      </section>
