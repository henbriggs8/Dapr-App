...
import { ArrowRight, CheckCircle2, Clock, MapPin, Shield, Star, Zap, ChevronRight, Smartphone, CreditCard } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#8c52ff] selection:text-white font-sans overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-8 flex items-center justify-between">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/60">
              ...
              <a href="#" className="hover:text-white transition-colors">For Fleets</a>
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="bg-white text-black px-5 py-2.5 rounded-full text-sm font-bold hover:bg-white/90 transition-transform hover:scale-105 active:scale-95">
              Book a Wash
            </button>
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-8 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6">
              The premium car wash that <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8c52ff] to-[#b28cff]">comes to you.</span>
            </h1>
            ...
            <div className="flex items-center gap-4">
              <button className="bg-[#8c52ff] text-white px-8 py-4 rounded-full text-base font-bold hover:bg-[#7a42e5] transition-all hover:scale-105 active:scale-95 flex items-center gap-2 shadow-[0_0_40px_-10px_#8c52ff]">
                Book Now <ArrowRight className="w-4 h-4" />
              </button>
              <button className="bg-white/5 text-white border border-white/10 px-8 py-4 rounded-full text-base font-bold hover:bg-white/10 transition-all">
                View Services
              </button>
            </div>
          ...
          <div className="relative w-full aspect-square lg:aspect-auto lg:h-[700px] rounded-3xl border border-white/10 bg-[#0a0a0a] overflow-hidden shadow-2xl">
            <img 
              src="/__mockup/images/hero-car.png" 
              alt="Dapper Wash" 
            ...
            <div className="absolute top-8 left-8 right-8 flex justify-between items-start">
              <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-4 w-64 shadow-2xl animate-fade-in-up">
            ...
            <div className="absolute bottom-8 right-8 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-2xl animate-fade-in-up delay-100 flex items-center gap-4">
              <div className="relative">
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#8c52ff]">
                  <img src="https://api.dicebear.com/7.x/notionists/svg?seed=Marcus&backgroundColor=transparent" alt="Detailer" className="w-full h-full bg-[#1a1a1a]" />
                </div>
      ...
      <section className="py-10 border-y border-white/5 bg-white/[0.02]">
        <div className="max-w-[1280px] mx-auto px-8">
          <p className="text-center text-sm font-medium text-white/40 mb-8 uppercase tracking-widest">Trusted by fleets & professionals at</p>
          <div className="flex flex-wrap justify-center gap-12 lg:gap-24 opacity-40 grayscale">
            ...
            {['Acme Corp', 'Global Tech', 'Pinnacle', 'Nexus', 'Stark Ind'].map((name, i) => (
              <div key={i} className="text-xl font-bold tracking-tighter">{name}</div>
            ))}
          </div>
        </div>
      </section>

      {/* How it works - Kinetic UI Grid */}
      <section className="py-32 relative">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl lg:text-5xl font-bold tracking-tight mb-6">Frictionless from tap to shine.</h2>
            <p className="text-lg text-white/60">We rebuilt the car wash experience around your time. No waiting in lines, no subpar results. Just seamless technology and expert detailers.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0a0a0a] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors group">
              ...
              <p className="text-white/60 leading-relaxed mb-8">Select your service, choose a time, and tell us where the car is parked. We handle the rest.</p>
            ...
            <div className="bg-[#0a0a0a] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors group">
              ...
              <p className="text-white/60 leading-relaxed mb-8">Watch your detailer en route on a live map. We bring our own water, power, and premium supplies.</p>
              <div className="aspect-[4/3] rounded-2xl bg-[#111] border border-white/5 relative overflow-hidden">
                <img src="/__mockup/images/dark-map.png" alt="Map" className="absolute inset-0 w-full h-full object-cover opacity-50" />
            ...
            <div className="bg-[#0a0a0a] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors group">
              ...
              <p className="text-white/60 leading-relaxed mb-8">Get notified when your car is ready. Pay seamlessly through the app and drive a spotless car.</p>
              <div className="aspect-[4/3] rounded-2xl bg-[#111] border border-white/5 relative overflow-hidden">
                <img src="/__mockup/images/sparkling-car.png" alt="Clean Car" className="absolute inset-0 w-full h-full object-cover mix-blend-luminosity opacity-70 group-hover:scale-105 group-hover:mix-blend-normal transition-all duration-700" />
        ...
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-white/60">From a quick exterior refresh to a comprehensive showroom detail, select the perfect tier for your car's needs.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col p-8 rounded-3xl bg-[#0a0a0a] border border-white/5">
              ...
              <button className="w-full py-3 rounded-full border border-white/10 font-bold hover:bg-white hover:text-black transition-colors">
                Select Basic
              </button>
            </div>
            ...
            <div className="flex flex-col p-8 rounded-3xl bg-gradient-to-b from-[#1a1033] to-[#0a0a0a] border border-[#8c52ff]/30 relative transform md:-translate-y-4 shadow-[0_0_40px_-15px_#8c52ff]">
              ...
              <button className="w-full py-3 rounded-full bg-[#8c52ff] font-bold hover:bg-[#7a42e5] transition-colors">
                Select Standard
              </button>
            </div>
            ...
            <div className="flex flex-col p-8 rounded-3xl bg-[#0a0a0a] border border-white/5">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                {['Everything in Standard', 'Spray wax application', 'Leather cleaning & conditioning', 'Floor mat shampooing', 'Deep crevice cleaning'].map((feature, i) => (
                  <li key={i} className="flex items-start gap-3 text-sm text-white/80">
                    <CheckCircle2 className="w-5 h-5 text-[#8c52ff] shrink-0" />
                    {feature}
                  </li>
        ...
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative rounded-3xl overflow-hidden aspect-[4/5] lg:aspect-auto lg:h-[600px] border border-white/10">
              <img src="/__mockup/images/interior-detail.png" alt="Interior Detailing" className="w-full h-full object-cover opacity-80" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#050505] via-transparent to-transparent" />
            ...
            <div className="max-w-xl">
              ...
              <button className="mt-10 flex items-center gap-2 text-[#8c52ff] font-bold hover:text-white transition-colors">
      ...
      <section className="py-32 relative border-t border-white/5">
        ...
        <div className="max-w-[1280px] mx-auto px-8 relative z-10 text-center">
          ...
          <button className="bg-white text-black px-10 py-5 rounded-full text-lg font-bold hover:bg-white/90 transition-transform hover:scale-105 active:scale-95 shadow-[0_0_40px_-10px_rgba(255,255,255,0.5)]">
